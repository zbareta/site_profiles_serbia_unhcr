...
<html lang="en">
	...
	<link href='http://fonts.googleapis.com/css?family=Lato:400,700' rel='stylesheet' type='text/css'>
		...
		-->
		<?php
		$fp = fopen("sitelog.txt", "r"); 
		$count = fread($fp, 1024); 
		fclose($fp); 
		$count = $count + 1; 
		//echo "<p>Page views:" . $count . "</p>"; 
		$fp = fopen("sitelog.txt", "w"); 
		fwrite($fp, $count); 
		fclose($fp); 
		?> 
		...
		$traffic_yellow = "<td style='width:10'><img src='yellow_light.png' alt='Yellow Light'></td>";
		$traffic_red = "<td style='width:10'><img src='red_light.png' alt='Red Light'></td>";
		$traffic_green = "<td style='width:10'><img src='green_light.png' alt='Green Light'></td>";
		$traffic_gray = "<td style='width:10'><img src='gray_light.png' alt='Gray Light'></td>";
		
		//This creates a function getRow where $field is used to store location name data pulled from KoBo
		//the loop goes through the entire array of pulled data, compares the location name $field with the $search results submited through the HTML form
		//it first checks if something was submited 
		...
		//this calls the above function (if there was a submission) and stores the selected locations row number in the $locationId variable
			if (!isset($_GET["search"])){$search_result = "Adasevci";}else{$search_result = $_GET["search"];}			
			$locationId = getRow($locations, 'GENERAL_INFO/Location_Name', $search_result);
...
if (!isset($locations[$locationId]['STATISTICS/Number_of_Persons_from_Syria'])){$locations[$locationId]['STATISTICS/Number_of_Persons_from_Syria']="No data";}
			  ...
			  <script type="text/javascript">
			    ...
			    function drawChart() {
			      var data = google.visualization.arrayToDataTable([
			        ...
			        ["Afghanistan", <?php echo $locations[$locationId]['STATISTICS/Number_of_Persons_from_Afghanistan']?>, "#0072BC"],
			        ["Iraq", <?php echo $locations[$locationId]['STATISTICS/Number_of_Persons_from_Iraq']?>, "#0072BC"],
			        ["Pakistan", <?php echo $locations[$locationId]['STATISTICS/Number_of_Persons_from_Pakistan']?>, "#0072BC"],
			        ["Syria", <?php echo $locations[$locationId]['STATISTICS/Number_of_Persons_from_Syria']?>, "#0072BC"],
			        ["Other", <?php echo $locations[$locationId]['STATISTICS/Number_of_Persons_Other']?>, "#0072BC"]
			      ]);
	...
	<body>
		...
		<div align="center">
			<table style="font-family: 'Lato', sans-serif; font-size: 14;">
				<tr>
					<td colspan="3">
					<form method="POST" action="<?php echo htmlspecialchars('overview.php');?>">
								<input type="submit" name="submit" value="Return to Overview" style="background-color: #0072BC; color: white; border: 0"></div>
						</form>
		...
		-->
				...
				<tr>
					<td colspan="7" style="background-color: white ;font-family: 'Lato', sans-serif; font-size: 14; font-weight: bold;">Countries of Origin:</td>	
				</tr>
				<tr>
			 		<td colspan="7" style="background-color: white ;font-family: 'Lato', sans-serif; font-size: 14;">
			 			<table>
			 				<tr>
			 				<div align="center" id="columnchart_values" style="width: 800px; height: 400px;"></div>
			 				</tr>
			 				<tr>
			 	...
			 	<tr>
				    ...
				    <td style="width: 40"></td>
				    <?php
				    	$q_answer = $locations[$locationId]['FOOD_NFI/Adequate_Storage_Distribution_Space'];
					    if ($q_answer == "partially"){echo $traffic_yellow;}
					    elseif ($q_answer == "yes"){echo $traffic_green;}
					    elseif ($q_answer == "no"){echo $traffic_red;}
					    else{echo $traffic_gray;}
				...
				This is the 3W section. It doesnt use traffic lights, it simply displays the data provided from KoBo in a table
			 	...
			 	<tr>
			 		...
			 		<td colspan="5" width="340" style="background-color: #CCCCCC ;font-family: 'Lato', sans-serif; font-size: 14; color: black; text-align: center; height: 50"><?php echo $locations[$locationId]['_3W/Agencies_Protection']?></td>
			 	</tr>
			 	<tr>
			 		...
			 		<td colspan="5" width="340"  style="background-color: #CCCCCC ;font-family: 'Lato', sans-serif; font-size: 14; color: black; text-align: center; height: 50"><?php echo $locations[$locationId]['_3W/Agencies_Admin_Legal_Info']?></td
			 	</tr>
			 	<tr>
			 		...
			 		<td colspan="5" width="340"  style="background-color: #CCCCCC ;font-family: 'Lato', sans-serif; font-size: 14; color: black; text-align: center; height: 50;"><?php echo $locations[$locationId]['_3W/Agencies_Health']?></td
			 	</tr>
			 	<tr>
			 		...
			 		<td colspan="5" width="340"  style="background-color: #CCCCCC ;font-family: 'Lato', sans-serif; font-size: 14; color: black; text-align: center; height: 50"><?php echo $locations[$locationId]['_3W/Agencies_Education']?></td
			 	</tr>
			 	<tr>
			 		...
			 		<td colspan="5" width="340"  style="background-color: #CCCCCC ;font-family: 'Lato', sans-serif; font-size: 14; color: black; text-align: center; height: 50"><?php echo $locations[$locationId]['_3W/Agencies_Food_and_Nutrition']?></td
			 	</tr>
			 	<tr>
			 		...
			 		<td colspan="5" width="340"  style="background-color: #CCCCCC ;font-family: 'Lato', sans-serif; font-size: 14; color: black; text-align: center; height: 50"><?php echo $locations[$locationId]['_3W/Agencies_NFI']?></td
			 	</tr>
			 	<tr>
			 		<td colspan="2" style="background-color: #CCE3F2;font-family: 'Lato', sans-serif; font-size: 14; font-weight: bold; color: black; text-align: right; center; height: 50">SHELTER</td>
			 		<td colspan="5" width="340"  style="background-color: #CCCCCC ;font-family: 'Lato', sans-serif; font-size: 14; color: black; text-align: center; height: 50"><?php echo $locations[$locationId]['_3W/Agencies_Shelter']?></td
			 	</tr>
			 	<tr>
			 	...
			 	<tr>
			 		...
			 		<td colspan="5" width="340"  style="background-color: #CCCCCC ;font-family: 'Lato', sans-serif; font-size: 14; color: black; text-align: center; height: 50"><?php echo $locations[$locationId]['_3W/Agencies_Local_Community_Support']?></td
			 	</tr>
			 	<tr>
			 	<!--
